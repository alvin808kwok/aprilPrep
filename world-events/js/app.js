// Make history, or better yet...make the World Events page 
// interactive with events or event listeners for each exercise below.

// 1. The Greatest Thing Since Sliced Bread 
// Find the onclick event in the h3 element and 
//create a function that will italicize the contents and 
//change the font color to cornflowerblue in the div id of 'bread'.
...
// Find the onmouseover event in the h3 element and 
//create a function that will replace the current contents 
//in the div id of 'webby' to the following:
...
// Find the onclick event in div id of 'fightDaPower' and 
//create a function that will convert the Chinese text in the 
//same div element into English (the English content is provided below).
...
// Add an event listener to the h3 element id of 'hardTimes' and create a 
//function to display the contents in the div element of 'depress'.
...
// 5. Apollo 11
// Add an event listener to the h3 element id of 'blastOff' and create a 
//function to show and hide the contents in the div element of 
//'moonWalk' after clicking on Apollo 11.
...
// Add an event listener to the div element id of 'freedom' and create a 
//function to remove all instances of 'corn' in the content.
...
// 7. The Renaissance
// Add an event listener to the div element id of 'rebirth' and create a 
//function to remove all the lowercase and uppercase z's in the content. 
...
// Add an event listener to the h3 element id of 'showBooks' and create a 
//function to display a random book title from the classics array 
//in the div element of 'mustRead'.
...
// 9. World War II
// Add an event listener to the image element and create a function 
//that will toggle between images when hovering (mouseover) on the image.
...
// Add an event listener to the h3 element and create a function 
//that will reverse the contents in the div element id of 'gameChanger'
...
// Final Boss
// Add event listeners for the thumbs up and thumbs down images that 
//will count the number of times the thumb has been clicked on. 
