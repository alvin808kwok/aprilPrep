...
console.log(longestPlaceName + ' is the longest place name in the world and has ' + howManyLetters + ' letter in its name.');
...
/*The slice() method extracts a part of a string and returns the extracted part into a new string. 
...
/*5. Declare a new variable named `theSifu` that will change the current string from "In order to taste my cup of water you must first fill your cup." to 
