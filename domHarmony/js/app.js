...
//6. In the div id data section, 
// create a div with an id of hobbies and give it the following information: 
// Long romantic walks on the beach, candle light Big Mac dinners and tormenting the King.
...
//7. In the div id data section, 
//create a div with an id of location and give it the following information: 
//Honolulu, HI.
...
//8. In the div id data section, 
//create a div with an id of wants and give it the following information: 
//Looking for a Mrs. McDonald.
...
//9. In the div id profile section, 
//create a paragraph element with an id of pro2 and create 
//a your own profile for Ronald (at least 2 sentences).

var profileBox = document.createElement('div');
profileBox.id = 'pro2';
profileBox.innerHTML = "I would consider myself a punny man. Nominated for 'Class Clown'. Not IT. Get IT?";
profile.appendChild(profileBox);

//10. In the div id matches section, 
//target the first div element with the class name of firstName 
//and change Name to Wendy.

var nameElem = document.getElementsByClassName('firstName');
nameElem[0].innerHTML = 'Wendy';

//11. In the div id matches section, 
//target the first div element with the class name of otherAge 
//and change Age to 48.

var ageElem = document.getElementsByClassName('otherAge');
ageElem[0].innerHTML = '48';

//12. In the div id matches section, 
//target the first div element with the class name of status 
//and change Status to Single Mother.

var statusElem = document.getElementsByClassName('status');
statusElem[0].innerHTML = 'Single Mother';

//13. In the div id matches section, 
//target the second div element with the class name of firstName 
//and change Name to Peko Chan.

var nameElem = document.getElementsByClassName('firstName');
nameElem[1].innerHTML = 'Peko Chan';

//14. In the div id matches section, 
//target the second div element with the class name of otherAge 
//and change Age to 68.
...
var nameElem = document.getElementsByClassName('firstName');
nameElem[2].innerHTML = 'Starbucks'; 

var nameAge = document.getElementsByClassName('otherAge');
ageElem[2].innerHTML = 48;

var statusElem = document.getElementsByClassName('status');
statusElem[2].innerHTML = 'Widowed';

var mottoElem = document.getElementsByClassName('motto');
mottoElem[2].innerHTML = 'Morebucks Coffee'

var imgBox = document.getElementsByClassName('other');
console.log(imgBox);
imgBox[2].src = 'images/StarbucksLogo.jpg';
