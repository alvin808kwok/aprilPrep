 ...
 *
 * This function will return the string "Mariah Carey has been married `x` amount of times." Where `x` is the value when you invoke the function. 
 * Invoke this function using the variable `daDiva`. 
...
// }
// // var fuckenSlut = checkSum(bango2);
// // console.log(fuckenSlut);
 ...
 *    @return Datatype: String
 *
 * This function will return the string "Last night I dreamt that I ate `x` Taco Bell soft tacos."  Where `x` is the value when you invoke the function. 
 * Invoke this function using the variable `difference`.
...
// }
// // var munchies = checkDifference(bango1);
...
// console.log('sum * product:', showResult);
...
// }
// var showResult2 = checkQuotient();
// console.log('product * quotient:', showResult2);
...
// // }
// // console.log('x + y - z:', addThenSubtract(bango3, bango4, bango5));
...
// }
// console.log('add then subtract:', addThenSubtract(bango3, bango4, bango5));
...
// //     return num1 * num2 / num3;
// // }
// // console.log('x * y / z:', multiplyThenDivide(bango3, bango4, bango5));

// function multiplyThenDivide(num1, num2, num3){
//     return divide(multiply(num1, num2), num3);
// }
// console.log('multiply then divide:', multiplyThenDivide(bango3, bango4, bango5));
...
// }
// var myFullName = createFullName('Greatest', 'Ever');
...
// //     return firstName + ' ' + lastName + ' eats ' + food + ' everyday for every meal.'
// // }
// // console.log(eatFood('Greatest', 'Ever', "W's"));

// function eatFood(firstName, lastName, food){
//     return createFullName(firstName, lastName) + ' eats ' + food + ' all day everyday.';
// }
// console.log(eatFood('Greatest', 'Ever', "W's"));
...
// //     return multiply(inches, 2.54);
// // }
// // var myShoeSize = shoeSize(12);
// // console.log('my shoe size in cm:', myShoeSize);
...
// // var ft2in = feet * 12;
// //     var in2cm = inches * 2.54;
// //     var ft2cm = feet * 30.48;

// function height(feet, inches, centimeters){
//     var ft2in = feet * 12 + inches;
//     var ft2cm = feet * 30.48 + inches/12*30.48;
//     return 'my height in inches = ' + ft2in + '. ' + 'my height in centimeters = ' + ft2cm + '.';
// }
// var myHeight = height(6, 3, 0);
...
// // }
// // var capStr = allCaps('i can go the distance');
// // console.log(capStr);

// function allCaps(str){
//     return str.toUpperCase();
// }
// console.log(allCaps('i can go the distance'));

// // function allCaps(str){
// //     return str.toUpperCase();
// // }
// // var stringCaps = allCaps('all capital letters');
...
// // var string = 'astronaut'
// // var oneCap = string.charAt(0).toUpperCase() + string.slice(1);
// // console.log(oneCap);
...
//     }else{
//         return 'Meh, see you at Chuck E Cheese little one'
//     }
// }
// var canParty = throwParty(21);
