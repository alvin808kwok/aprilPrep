...
shoppingList.push('Hendicks gin');
...
/*5. Apparently, you didn't do a good job with crowd control in the previous exercise. Kanye just cut in front of everyone!. 
Add Kanye to the waitList array above. Console.log waitList*/
...
/*6. As head of McDonald's New Product Division, your job is to test and approve all new menu items. 
...
/*7. Increase the peace! Your job is quash the bitter rivalry and unite both the westSide and eastSide rappers into a new array called `oneLove`. 
...
/*8. Help Nike sell more overpriced sneakers by changing their slogan from an array into a string. 
...
/*9. Some drama between you and the Kardashian's went down during last Saturday's potluck party. 
You are no longer on speaking terms and need to unfriend the following from your facebook: "Yeezy", "Kimmy K" and "Lamar Odom". 
Unfriend these ungrateful people and assign them to a new variable named `unFriend`. Console.log this new variable.*/
...
// var meRight = 'I know I was right. It is bring a dress to work day. Cover em nips ladies!';
// console.log(meRight);
