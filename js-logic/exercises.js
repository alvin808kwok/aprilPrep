...
/*
If/else statements = Evaluates (or checks) a condition. If the condition is true, the first code block is executed. 
...
var showResult = isGreaterThan(5, 3);
console.log('3. isGreaterThan: ' + showResult);
...
console.log('6. ' + isEqual('Kanye', 'Kanye'));
//console.log(isEqual('Kanye', 'betterLookingKanye'))
...
console.log('7. ' + notEqual('ying', 'yang'));
...
console.log('9. dirty30: ' + dirty30(10, 20, 25));
...
console.log('10. evenStevens: ' + evenStevens(888));
...
function daClub(cover, age){
  if(cover >= 21 && age >= 21){
    ...
    return 'Chuck E Chees is across the street.'
  }
}
console.log('11. daClub: ' + daClub(21, 21));
 ...
 *  @return Datatype: String
 *
 * If EITHER the credits value is greater than or equal to 120 or the grades value is greater than or equal to 2.0, 
 * then the function will return the message: "Congratulations on a job well done." 
 * Otherwise, return the message: "See you in summer school."
 * Console.log your result.
*/ 
...
console.log('12. graduation: ' + gradResults)
 ...
 *  @return Datatype: String
 *
 * The function will return the message: "You are riding Honolulu's Rail.", if the number value is less than 50, 
 * otherwise it will return the message: "You are riding an Amtrak.", if the number value is less than 100, 
 * and return the message: "Now you ballin' in the Shinkansen!", if the number value is greater than or equal to 100.
 * Console.log your result.
*/ 
...
buyDoughnut();
console.log("14 a. budget: " + budget);
console.log("14 b. bought: " + doughnutBought);
...
//   return menu;
// }  
// console.log('Monday Special: ', dailySpecials('Monday'));
// console.log('Tuesday Special: ', dailySpecials('Tuesday'));
// console.log('Wednesday: ', dailySpecials('Wednesday'));
// console.log('Thursday Special: ', dailySpecials('Thursday'));
// console.log('Friday Special: ', dailySpecials('Friday'));

/*
For loops - A for loop checks a condition a specific number of times and allows us to execute a code block and 
evaluate a condition to determine if our loop should run again.
...
console.log('17. total: ' + sumItUp(numArray));
...
allStars(players);
console.log('18 a. east: ' + east);
console.log('18 b. west: ' + west);
 ...
 *   @return Datatype: Array
 *
 *  The function will loop through the string value and put all the letters into an array, except for the letter "A" and "a". 
 * We don't want no stinking "A" or "a" in our array. Test your function with the `phrase` below!
*/
